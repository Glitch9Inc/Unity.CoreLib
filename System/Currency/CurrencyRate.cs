...
namespace Glitch9
{
    ...
    public class CurrencyConverter
    {
        ...
        public float Convert(float amount, CurrencyCode fromCurrency, CurrencyCode toCurrency)
        {
            ...
            float amountInUSD = amount * _rates[fromCurrency].ToUSD;
