...
namespace Glitch9.Internal
{
    public class UnityMenu
    {
        ...
        public static class SmartLocalization
        {
            ...
            // Menus
            public const string NAME_SMART_LOCALIZATION = ROOT_TOOL_PATH + NAME;
            public const string NAME_LOCALIZATION_MANAGER = "Localization Manager";

            public const string PATH_LOCALIZATION_MANAGER = NAME_SMART_LOCALIZATION;
            ...
            public const string PROVIDER_SETTINGS = ROOT_USER_PREFERENCE + NAME;
            public const string PROVIDER_TABLE_SETTINGS = ROOT_USER_PREFERENCE + NAME + "/Localization Tables";
            public const string PROVIDER_CONTRIBUTOR_SETTINGS = ROOT_USER_PREFERENCE + NAME + "/Contributors (Translators)";
            public const string PROVIDER_CONTEXT_KEY_SETTINGS = ROOT_USER_PREFERENCE + NAME + "/Context Keys";
        }
...
#if UNITY_EDITOR
            [UnityEditor.MenuItem(PATH_REPORT_AN_ISSUE, priority = PRIORITY_REPORT_AN_ISSUE)]
            public static void OpenSupportURL()
            {
                Application.OpenURL(URL_SUPPORT_REPO);
            }

            [UnityEditor.MenuItem(PATH_OPEN_PERSISTENT_DATA_PATH, priority = PRIORITY_OPEN_PERSISTENT_DATA_PATH)]
