...
namespace Glitch9
{
    ...
    public class Result : IResult
    {
        ...
        public static IResult Fail(Issue issue, params string[] additionalMessages) => new Error(issue, additionalMessages);
        ...
        /// <param name="additionalMessages">Additional messages to associate with the error.</param>
        /// <returns>An error <see cref="IResult"/>.</returns>
        public static IResult Fail(Exception ex, params string[] additionalMessages) => new Error(ex, additionalMessages);
    ...
    public class Result<T> : Result
    {
        ...
        public static IResult Fail(T value, Issue issue, params string[] additionalMessages) => new Error<T>(value, issue, additionalMessages);
        ...
        /// <param name="additionalMessages">Additional messages to associate with the error.</param>
        /// <returns>An error <see cref="IResult"/> with a value.</returns>
        public static IResult Fail(T value, Exception ex, params string[] additionalMessages) => new Error<T>(value, ex, additionalMessages);
    }
}
