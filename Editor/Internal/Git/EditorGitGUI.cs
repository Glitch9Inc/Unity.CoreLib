    ...
    public class EditorGitGUI
    {
        ...
        private void DrawPushAndPullMenu()
        {
            ...
            EGUILayout.MultiButton("Download (Pull)", new EGUIButtonEntry("Pull", () => RunGitCommandsAsync("pull")),
                new EGUIButtonEntry("Hard Reset", HardResetAsync));
        }

        private async void HardResetAsync()
        {
            await _editorGit.HardResetAsync();
        }
        ...
        private void DrawDebugMenu()
        {
            ...
            EGUILayout.MultiButton("Other Commands",
                ...
                new EGUIButtonEntry("Push tag", PushVersionTagAsync),
                new EGUIButtonEntry("Show Login Info", ShowLoginInformation));
        }

        private async void PushVersionTagAsync()
        {
            await _editorGit.PushVersionTagAsync();
        }
