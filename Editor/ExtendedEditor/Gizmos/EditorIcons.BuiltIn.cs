...
namespace Glitch9.ExtendedEditor
{
    ...
    public static partial class EditorIcons
    {
        ...
        public static Texture Pencil => GetBuiltInIcon("In-Development");
        public static Texture Pencil2x => GetBuiltInIcon("In-Development@2x");
        public static Texture Text => GetBuiltInIcon("Text Icon");
        public static Texture BuiltIn => Settings;
        public static Texture Clipboard => GetBuiltInIcon("Clipboard", true);
