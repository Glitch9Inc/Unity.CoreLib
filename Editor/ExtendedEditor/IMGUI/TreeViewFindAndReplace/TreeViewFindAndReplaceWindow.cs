...
namespace Glitch9.ExtendedEditor.IMGUI
{
    public class TreeViewFindAndReplaceWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            if (EGUILayout.EnumToolbar(_mode, out FNRMode newMode))
            {
                _mode = newMode;
                UpdateModeUI();
            }
            EGUIUtility.DrawHorizontalBorder(20);
            ...
            GUILayout.BeginVertical(TreeViewStyles.FindAndReplaceLayout);
            {
                ...
                _textInputFind = GUILayout.TextArea(_textInputFind, EGUI.skin.textArea, GUILayout.ExpandWidth(true), GUILayout.Height(textFieldHeight));
                ...
                if (_mode == FNRMode.Replace)
                {
                    ...
                    _textInputReplace = GUILayout.TextArea(_textInputReplace, EGUI.skin.textArea, GUILayout.ExpandWidth(true), GUILayout.Height(textFieldHeight));
                }
                ...
                {
                    EGUILayout.TextureField(RoutinaIcons.Aimi, new Vector2(36, 36));
            ...
            else
            {
                ...
                if (_mode == FNRMode.Replace)
                {
                    ...
                    {
                        if (string.IsNullOrEmpty(_textInputFind) || string.IsNullOrEmpty(_textInputReplace)) return;
                        if (EGUI.Confirmation(Strings.CONFIRMATION_REPLACE_TEXT))
                        {
