...
namespace Glitch9
{
    ...
    [CustomPropertyDrawer(typeof(ExEnumAttribute))]
    public class ExEnumDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            if (property.propertyType == SerializedPropertyType.Enum)
            {
                ...
                string[] enumNames = ExEnum.GetNames(enumType);
                ...
                for (int i = 0; i < enumNames.Length; i++)
                {
                    ...
                    ExEnumAttribute attr = Attribute.GetCustomAttribute(field, typeof(ExEnumAttribute)) as ExEnumAttribute;
